...
return [
    ...
    'notifications' => [
        'new-device' => [
            ...
            // DISABLED by default: this fires an email synchronously on every
            // login from a new device (QUEUE_CONNECTION=sync), so a missing or
            // misconfigured SMTP host would break the login itself. Logins are
            // still recorded in the authentication_log table (Security group)
            // regardless. Set NEW_DEVICE_NOTIFICATION=true once SMTP is proven.
